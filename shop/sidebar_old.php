...
<div class="collpase col-auto d-lg-flex d-md-none" id="SidebarCollapse">
    <div class="flex-shrink-0 col-auto min-vh-100 bg-white p-3" style="width: 280px;">
        ...
        <ul class="list-unstyled">
            ...
            <li class="mb-1">
                <a type="button" data-bs-toggle="collapse" data-bs-target="#ManageCollapse" aria-expanded="false" class="fw-bold btn">การจัดการ</a>

                <div class="collapse px-3" id="ManageCollapse">
                    <ul class="list-unstyled small">
                        <li>
                            <a href="index.php?p=addproduct_type" class="text-muted link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">หมวดหมู่อาหาร</a>
                        </li>
                        <li>
                            <a href="index.php?p=product" class="text-muted link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">รายการอาหาร</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="mb-1">
                <a href="index.php?p=salesum" class="fw-bold btn">สรุปยอดขาย</a>
            </li>
